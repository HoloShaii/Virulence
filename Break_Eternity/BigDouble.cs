...
public struct BigDouble : IComparable, IComparable<BigDouble>, IEquatable<BigDouble>
{
    ...
    private const long
        MAX_ES_IN_A_ROW = 5; //For default toString behaviour, when to swap from eee... to (e^n) syntax.
    ...
    public double f_lambertw(double z, double tol = 1e-10)
    {
        ...
        throw new Exception($"Iteration failed to converge: ${z.ToString(CultureInfo.InvariantCulture)}");
        //return Number.NaN;
    }
    ...
    public BigDouble d_lambertw(BigDouble z, double tol = 1e-10)
    {
        ...
        throw new ArithmeticException($"Iteration failed to converge: ${z.ToString()}");
        //return dec.dNaN;
    }
